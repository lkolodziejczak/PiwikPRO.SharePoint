...
using PiwikPRO.SharePoint.SP2013;
using System;
                ...
                using (SPSite site = new SPSite(GetPropertyValueFromListByKey("piwik_adminsiteurl")))
                {
                    using (SPWeb web = site.OpenWeb())
                    {
                        try
                        {
                            ...
                            PropertyBagList.Add(new PropertyBagEntity("TemplateSendUserIdEncoded", ConfigValues.PiwikPro_PropertyBag_SendUserIdEncoded, Convert.ToString(web.Properties[ConfigValues.PiwikPro_PropertyBag_SendUserIdEncoded]), PropertyBagEntity.PropertyLevelEnum.PiwikAdmin));
