...
namespace PiwikPROSitesActivator.Shared
{
    public class ListProcessor
    {
        ...
        public ListProcessor(ClientContext context)
        {
        ...
        public bool AddOrUpdateElementInList(string title, string status, string url, string errorlog, string relativeUrl, string siteId)
        {
            ...
            {
                 Logger.WriteLine("Piwik AddOrUpdateElementInList: " + ex.Message);
            }
       ...
       "</Where></View></Query>";
            ...
            {
                Logger.WriteLine("Piwik GetAllNewSites: " + ex.Message);
            }
            return listToReturn;
        }
       ...
       "</Where></View></Query>";
            ...
            {
                Logger.WriteLine("Piwik GetAllNewSettingsUpdatedSites: " +  ex.Message);
            }
            return listToReturn;
        }
       ...
       "</Where></View></Query>";
            ...
            {
                Logger.WriteLine("Piwik GetAllDeactivatingSites: "+ ex.Message);
            }
            return listToReturn;
        }
   ...
   "</Where></View></Query>";
            ...
            {
                Logger.WriteLine("Piwik CheckIfElementIsAlreadyOnList: "+ ex.Message);
            }
